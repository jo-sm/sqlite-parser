...
const grammar = (await fs.readFile(`${projectRoot}/dist/grammar.pegjs`)).toString()
const parserSrc = peggy.generate(grammar, { allowedStartRules: ["start", "start_streaming"], cache: true, output: "source" })
